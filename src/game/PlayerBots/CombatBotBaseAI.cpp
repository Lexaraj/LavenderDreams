    ...
    for (const auto& spell : me->GetSpellMap())
    {
        ...
        switch (me->GetClass())
        {
            case CLASS_PALADIN:
            {
                ...
                else if (pSpellEntry->SpellName[0].find("Sacred Strike") != std::string::npos)
                {
                    if (IsHigherRankSpell(m_spells.paladin.pSacredStrike))
                        m_spells.paladin.pSacredStrike = pSpellEntry;
                }
                ...
                else if (pSpellEntry->SpellName[0].find("Geas") != std::string::npos)
                {
                    if (IsHigherRankSpell(m_spells.paladin.pGeas))
                        m_spells.paladin.pGeas = pSpellEntry;
                }
                break;
            }
            case CLASS_SHAMAN:
