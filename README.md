# Lavender Dreams - Custom 5-man Vanilla Server
This project is direct, and maintained, fork of the vmangos project with all content rebalanced for 5-mans groups as well as custom Class balance changes to make all specs viable.

### Project Goals
- Allow for all Vanilla WoW content to be completable by 5-man groups while maintaining similar challenge and mechanics as much as possible.
